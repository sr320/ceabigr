...
```{r}
plot(res, effect = 1, component = 5, type = 'effect', n_limit=3)
```

```{r}
plot(res, effect = 1, component = 6, type = 'effect', n_limit=20)
```

```{r}
plot(res, effect = 1, component = 7, type = 'effect', n_limit=20)
```

```{r}
plot(res, effect = 1, component = 8, type = 'effect', n_limit=20)
```

```{r}
plot(res, effect = 1, component = 9, type = 'effect', n_limit=20)
```

```{r}
plot(res, effect = 1, component = 10, type = 'effect', n_limit=20)
```
