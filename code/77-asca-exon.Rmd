...
then repeat with male 
will need to assemble in illustrator or other document 
...
```{r}
#individual plot
plot(res_male, component = 1, effect = 1, type = 'prediction', n_limit = 10, variable = c())
```

PC2
```{r}
#individual plot
plot(res_male, component = 2, effect = 1, type = 'prediction', n_limit = 10, variable = c())
```

PC3
```{r}
#individual plot
plot(res_male, component = 3, effect = 1, type = 'prediction', n_limit = 10, variable = c())
```

PC4
```{r}
#individual plot
plot(res_male, component = 4, effect = 1, type = 'prediction', n_limit = 10, variable = c())
```

PC5
```{r}
#individual plot
plot(res_male, component = 5, effect = 1, type = 'prediction', n_limit = 10, variable = c())
```

PC6
```{r}
#individual plot
plot(res_male, component = 6, effect = 1, type = 'prediction', n_limit = 10, variable = c())
```
...
```{r}
loadings5<-get_loadings(res_male, component=5, effect=1, n_limit=10)
list5<-loadings5[[1]]$covars
loadings6<-get_loadings(res_male, component=6, effect=1, n_limit=10)
list6<-loadings6[[1]]$covars
loadings7<-get_loadings(res_male, component=6, effect=1, n_limit=10)
list7<-loadings7[[1]]$covars

list<-c(list5, list6, list7)

capture.output(list, file="output/77-asca-exon/males_splicing_treatments_gene_list.csv")
```
