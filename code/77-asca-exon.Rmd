...
plot(res, component = 1, effect = 1, type = 'prediction', n_limit = 20, variable = c(), palette = c(plotColors[6], plotColors[8]))
dev.off()
```
...
plot(res, component = 2, effect = 1, type = 'prediction', n_limit = 20, variable = c(), palette = c(plotColors[6], plotColors[8]))
dev.off()
```
...
plot(res, component = 3, effect = 1, type = 'prediction', n_limit = 20, variable = c(), palette = c(plotColors[6], plotColors[8]))
dev.off()
```
...
plot(res, component = 4, effect = 1, type = 'prediction', n_limit = 20, variable = c(), palette = c(plotColors[6], plotColors[8]))
dev.off()
```
...
plot(res, component = 5, effect = 1, type = 'prediction', n_limit = 20, variable = c(), palette = c(plotColors[6], plotColors[8]))
dev.off()
```
...
plot(res, component = 6, effect = 1, type = 'prediction', n_limit = 20, variable = c(), palette = c(plotColors[6], plotColors[8]))
dev.off()
```
...
plot(res_male, component = 1, effect = 1, type = 'prediction', n_limit = 20, variable = c(), palette = c(plotColors[6], plotColors[8]))
dev.off()
```
...
plot(res_male, component = 2, effect = 1, type = 'prediction', n_limit = 20, variable = c(), palette = c(plotColors[6], plotColors[8]))
dev.off()
```
...
plot(res_male, component = 3, effect = 1, type = 'prediction', n_limit = 20, variable = c(), palette = c(plotColors[6], plotColors[8]))
dev.off()
```
...
plot(res_male, component = 4, effect = 1, type = 'prediction', n_limit = 20, variable = c(), palette = c(plotColors[6], plotColors[8]))
dev.off()
```
...
plot(res_male, component = 5, effect = 1, type = 'prediction', n_limit = 20, variable = c(), palette = c(plotColors[6], plotColors[8]))
dev.off()
```
...
plot(res_male, component = 6, effect = 1, type = 'prediction', n_limit = 20, variable = c(), palette = c(plotColors[6], plotColors[8]))
dev.off()
```
