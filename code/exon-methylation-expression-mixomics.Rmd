...
different filtering ideas:
  - expression data: filtered for low frequency genes (sum = 10 across all sample)
  - methylation data: < 10% methylation difference
  - P over A filtering
extract males and females from raw data, then re-filter
PLSDA
tune parameters
run spls
