...
for (comparison in comparisons) {
  ...
  if (comparison == "f_vs_m") {
    df1 <- transcript_counts_per_gene_per_sample_females %>% 
      select(gene_name, female_max_transcript_counts)
    
    df2 <- transcript_counts_per_gene_per_sample_males %>% 
      select(gene_name, male_max_transcript_counts)
  }
}
