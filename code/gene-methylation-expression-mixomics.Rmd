...
```{r}
range(femSelectedVariables1$X$value) #Selected genes from methylation data
range(femSelectedVariables1$Y$value) #Selected genes from expression data
```

```{r}
rbind(as.data.frame(femSelectedVariables1$X$value),
      as.data.frame(femSelectedVariables1$Y$value)) %>% write.csv(., "../output/gene-methylation-expression-mixomics/comp1SelectedVariables-Fem.csv")
```
...
ggsave("../output/gene-methylation-expression-mixomics/comp1Loadings-fem.pdf", width = 11, height = 8.5)
```
...
rbind(as.data.frame(femSelectedVariables2$X$value),
      as.data.frame(femSelectedVariables2$Y$value)) %>% write.csv(., "../output/gene-methylation-expression-mixomics/comp2SelectedVariables-Fem.csv")
```
...
plotLoadings(geneResult.splsFem, comp = 2, 
             ...
             subtitle = c("Methylation", "Expression"), size.subtitle = 2) #Loadings for first component
ggsave("../output/gene-methylation-expression-mixomics/comp2Loadings-fem.pdf", width = 11, height = 8.5)
```
...
rbind(as.data.frame(MaleSelectedVariables1$X$value),
      as.data.frame(MaleSelectedVariables1$Y$value)) %>% write.csv(., "../output/gene-methylation-expression-mixomics/comp1SelectedVariables-Male.csv")
```
...
plotLoadings(geneResult.splsMale, comp = 1, 
             ...
             subtitle = c("Methylation", "Expression"), size.subtitle = 2) #Loadings for first component
ggsave("../output/gene-methylation-expression-mixomics/comp1Loadings-male.pdf", width = 11, height = 8.5)
```
...
rbind(as.data.frame(MaleSelectedVariables2$X$value),
      as.data.frame(MaleSelectedVariables2$Y$value)) %>% write.csv(., "../output/gene-methylation-expression-mixomics/comp2SelectedVariables-Male.csv")
```
...
plotLoadings(geneResult.splsMale, comp = 2, 
             ...
             subtitle = c("Methylation", "Expression"), size.subtitle = 2) #Loadings for first component
ggsave("../output/gene-methylation-expression-mixomics/comp2Loadings-male.pdf", width = 11, height = 8.5)
```
