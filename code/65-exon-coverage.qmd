...
### Plot raw expression
```{r}
test_sum_head <- head(test_sum, 10)
...
# Assuming your data frame is named test_sum
# Replace "test_sum" with the actual name of your data frame

# Remove NA values
cleaned_data <- na.omit(test_sum[, -8])  # Excluding the Sum column
...
ggplot(long_data, aes(x = factor(Exon), y = Values)) +
  ...
  scale_y_log10() +
  labs(x = "Exon", y = "Values", title = "Dot Plot of Raw Exon Coverage") +
  theme_minimal()
