...
# Uses [Ballgown](https://github.com/alyssafrazee/ballgown) all transcripts expression table for calculating transcript counts per gene per sample in _C.virginica_ gonad tissue exposed to elevated pCO<sub>2</sub>.
