...
femMethExpCV %>%
  ...
  theme_classic()
ggsave("fem-TN-FPKM.pdf", height = 8.5, width = 11)
```
...
femMethExpCV %>%
  ...
  theme_classic()
ggsave("fem-TN-meth.pdf", height = 8.5, width = 11)
```
...
femMethExpCV %>%
  ...
  theme_classic()
ggsave("fem-TN-treatment.pdf", height = 8.5, width = 11)
```
...
femMethExpCV %>%
  ...
  theme_classic()
ggsave("fem-TN-predIso.pdf", height = 8.5, width = 11)
```

```{r}
femMethExpCV %>%
  ggplot(.) + geom_violin(aes(x = as.factor(bins), y = log10(CoV_FPKM), fill = as.factor(bins)), width = 1) +  
  geom_boxplot(aes(x = as.factor(bins), y = log10(CoV_FPKM)), width = 0.1, colour = "grey20", alpha = 0.2) +
  labs(x = "Gene Methylation", y = "Transcriptional Noise") +
  theme_classic()
ggsave("fem-TN-geneMeth.pdf", height = 8.5, width = 11)
```
## Males
...
maleMethExpCV %>%
  ...
  theme_classic()
ggsave("male-TN-FPKM.pdf", height = 8.5, width = 11)
```
...
maleMethExpCV %>%
  ...
  theme_classic()
ggsave("male-TN-meth.pdf", height = 8.5, width = 11)
```
...
maleMethExpCV %>%
  ...
  labs(x = "Treatment", y = "Transcriptional Noise") +
  theme_classic()
ggsave("male-TN-treatment.pdf", height = 8.5, width = 11)
```
...
maleMethExpCV %>%
  ...
  labs(x = "Predominant Isoform Shift", y = "Transcriptional Noise") +
  theme_classic()
ggsave("male-TN-predIso.pdf", height = 8.5, width = 11)
```
...
maleMethExpCV %>%
  ...
  labs(x = "Gene Methylation", y = "Transcriptional Noise") +
  theme_classic()
ggsave("male-TN-geneMeth.pdf", height = 8.5, width = 11)
```
