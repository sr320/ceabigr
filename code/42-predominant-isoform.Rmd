...
predIsoFemWideDML %>%
  ...
  scale_fill_manual(values = c(plotColors[5], plotColors[8]),
                    ...
                    name = "") +
  theme_classic(base_size = 15)
ggsave("frem-pred-isoform-DML-distribution.pdf", height = 8.5, width = 11)
```
...
```{r}
write.csv(broom::tidy(predIsoFemModel2), "fem-pred-isoform-model-output.csv", quote = FALSE, row.names = FALSE) #Save model output
```
