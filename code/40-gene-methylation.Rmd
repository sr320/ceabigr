...
mean.gene.methylation.CoV.list <- lapply(mean.gene.methylation.CoV.list, function(x){ rownames(x) <- gene.names; x })

# Convert row names to column and assign column name
mean.gene.methylation.CoV.list <- lapply(mean.gene.methylation.CoV.list, function(x){ rownames_to_column(x, var = "gene.id") })
