  ...
  if (comparison == "females_v_males") {
    ...
    methylation.transposed.rownames.list[[comparison]] <- 
      ...
      # If matrix does exist, append column to matrix
          ...
          transcripts_females_matrix <- cbind(methylation.transposed.rownames.list[[comparison]])
    
    # Set treatment column name
    # Splits comparison on "_" and keeps first entry using head()
    treatment_col <- paste(
      sapply(
        strsplit(
          comparison,
