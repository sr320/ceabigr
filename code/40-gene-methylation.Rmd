...
for (comparison in comparisons) {
  ...
  if (comparison == "all") {
    ...
    # Calculate coefficients of variation, convert to data fram and add to list
    methylation.transposed.rownames.list <- list(as.data.frame(rowcvs(methylation.transposed.matrix, unbiased = TRUE)))
    
    names(methylation.transposed.rownames.list) <- comparison
    
    names(methylation.transposed.rownames.list)[comparison] <- treatment_col
  }
}
